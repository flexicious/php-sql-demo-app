...
(function(window)
{
    ...
    PagerControl.prototype.initialize=function(){
        ...
        if(this.level.getNestDepth()==1){
            html+="<span id='"+gridId+"btnShare' class='pagerDiv iconCell'><img tabindex='0' style='width: 16px; height: 16px' src='images/share.png' class='imageButtonShare' alt='Share' title='Share'/></span>"+
    ...
    PagerControl.ACTION_SHARE = "share";
    ...
    PagerControl.prototype.processAction=function(code){
        ...
        }else if(code==PagerControl.ACTION_SHARE){
            this.grid.dispatchEvent(new flexiciousNmsp.BaseEvent("Share"));
        }
    ...
    flexiciousNmsp.CustomPagerRenderer = new flexiciousNmsp.ClassFactory(PagerControl);
    flexiciousNmsp.CustomPagerControl = PagerControl;
}(window));